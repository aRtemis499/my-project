...
// ── Plan config ──
const PLANS = {
  premium_monthly:     { amount: 35,  days: 30,  flwPlanId: process.env.FLW_MONTHLY_PLAN_ID },
  premium_semi_annual: { amount: 200, days: 180, flwPlanId: process.env.FLW_SEMI_ANNUALLY_PLAN_ID    },
  premium_yearly:      { amount: 360, days: 365, flwPlanId: process.env.FLW_YEARLY_PLAN_ID  },
};
